...
**Analytics & BI**
`SQL` `Python` `R` `Power BI` `Tableau` `Excel (Power Query)`

**Marketing & E-Commerce**
`Google Analytics (GA4)` `SEMrush` `Shopify` `Meta Ads` `GTM` `HubSpot` `Mailchimp`

**Data Engineering & AI**
`BigQuery` `Snowflake` `ETL/ELT` `Microsoft Fabric` `AWS` `Azure` `LangChain` `RAG`

**Business**
`A/B Testing` `RFM Segmentation` `K-Means` `CAC · LTV · ROAS · AOV · Churn` `Agile` `Jira`

---

## 📈 GitHub Stats

![Pratham's GitHub stats](https://github-readme-stats.vercel.app/api?username=PrathamKabra&show_icons=true&theme=default&hide_border=true)
